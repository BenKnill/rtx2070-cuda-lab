...
LOG="$LOG_DIR/wsl-probe-fluidsgl-capture-motion-$STAMP.txt"
exec > >(tee -a "$LOG") 2>&1

echo "Probe fluidsGL captured frame motion $STAMP"
...
frame_dir = Path("/mnt/c/Users/18572/blender-wsl-render/cuda_demo_output/fluidsgl_frames")
